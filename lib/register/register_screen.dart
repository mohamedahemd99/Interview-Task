...
import 'package:task1_app/register/cubit/register_states.dart';

import '../screens/getuser.dart';
import '../constants/reused_widget.dart';
      ...
      child: BlocConsumer<RegisterCubit,RegisterStates>(
          listener:(context, state) {
            if(state is RegisterSuccessState){
              navigateAndFinish(context,GetUserScreen(RegisterCubit.get(context).name));
            }
          },
